...
var projects = new []
{
    sourceDir.Path + "Pokemon_API/Pokemon_API.csproj",
...
...
    GetPokemon:
        ...
        Properties:
            CodeUri: ./artifacts/Pokemon_API.zip
            ...
```
...
```bash
sam package --template-file template.yaml --output-template-file packaged.yaml --s3-bucket deploys.my-sid
```
...
aws cloudformation describe-stacks \
    --stack-name timeinterpreter --query 'Stacks[].Outputs'
```
